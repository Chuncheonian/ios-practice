...
//  MusicPlayer
//
//  Created by dykoon on 2021/08/26.
//
...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func initializePlayer() {
        ...
        self.progressSlider.maximumValue = Float(self.player.duration)  // maximumValue는 Float형식, duration은 Double형식
        self.progressSlider.minimumValue = 0
        self.progressSlider.value = Float(self.player.currentTime)
    }
    
    // timeLabel에 음원 현재 시간 입력
    func updateTimeLabelText(time: TimeInterval) {
        ...
        let timeText: String = String(format: "%02ld:%02ld:%02ld", minute, second, milisecond)  // ld : long
